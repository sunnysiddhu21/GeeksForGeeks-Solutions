<h2><a href="https://www.geeksforgeeks.org/problems/height-of-binary-tree/1?page=1&category=Tree&company=Amazon&difficulty=Easy&sortBy=submissions">Height of Binary Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary tree, find its height.</span></p>
