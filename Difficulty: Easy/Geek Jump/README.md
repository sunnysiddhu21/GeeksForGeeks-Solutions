...
<pre data-copier-init="true"><span style="font-size:18px"><strong>Example:</strong>
<strong>Input:</strong>
n = 4
height = {10 20 30 10}
...
<code data-copier-init="true">Geek jump from 1st to 2nd stair(|20-10| = 10 energy lost).
...
<p><strong><span style="font-size:18px"><code data-copier-init="true">Your Task:</code></span></strong><br>
